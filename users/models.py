...
class UserProfile(models.Model):
    ...
    def __str__(self):
        # بازگشت یک مقدار پیش‌فرض در صورت عدم وجود nickname یا username
        return self.nick_name or self.user.username or "Unnamed User"
class Device(models.Model):
    ...
    def __str__(self):
        return f"Device {self.device_uuid}" if self.device_uuid else "Unnamed Device"
...
class Province(models.Model):
    ...
    def __str__(self):
        return self.name or "Unnamed Province"
